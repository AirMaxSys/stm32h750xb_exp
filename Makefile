##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.3.0-B58] date: [Mon Jun 10 00:12:02 CST 2024] 
##########################################################################################################################
...
upload:$(BUILD_DIR)/$(TARGET).bin
	@openocd -f "interface\\stlink.cfg" -f "target\\stm32h7x.cfg" \
		...
		-c "program $< 0x08000000 reset exit"
